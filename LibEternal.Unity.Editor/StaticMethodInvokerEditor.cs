...
using UnityEditor;
using UnityEngine;
using AssemblyExtensions = LibEternal.Extensions.AssemblyExtensions;
...
namespace LibEternal.Unity.Editor
{
	...
	public sealed class StaticMethodInvokerEditor : UnityEditor.Editor
	{
		...
		private void Init()
		{
			...
			var types = AppDomain.CurrentDomain.GetAssemblies().SelectMany(AssemblyExtensions.GetTypesSafe);
